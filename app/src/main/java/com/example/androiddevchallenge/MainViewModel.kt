...
class MainViewModel : ViewModel() {
    val dogs by mutableStateOf(
        listOf(
            ...
            Dog(
                "Eurasier", "Pit Bull Terrier", "Santa Clara, CA",
                "Young", "Female", "Medium", R.drawable.img_puppy_sia
            ),
            Dog(
                "Cavachon", "Chihuahua & Terrier Mix", "Santa Clara, CA",
                "Young", "Female", "Medium", R.drawable.img_puppy_layla
            ),
            Dog(
                "Golden", "Border Collie & German Shepherd Dog Mix", "Los Altos, CA",
                "Young", "Male", "Medium", R.drawable.img_puppy_rumi
            ),
            Dog(
                "Rat Terrier", "Chihuahua & Rat Terrier Mix", "Santa Clara, CA",
            ...
            Dog(
                "Norfolk Terrier", "Mountain Dog & Shepherd Mix", "Sunnyvale, CA",
                "Puppy", "Male", "Medium", R.drawable.img_puppy_bowen
            ),
            Dog(
                "Terripoo", "Pit Bull Terrier Mix", "Sunnyvale, CA",
                "Adult", "Female", "Large", R.drawable.img_puppy_nala
            ),
            Dog(
                "Westiepoo", "Pit Bull Terrier Mix", "Santa Clara, CA",
            ...
            Dog(
                "Pyredoodle", "Chihuahua Mix", "Mountain View, CA",
